...
export default function NavigationBar({ visible }: { visible: boolean }) {
   ...
   return (
      <AppearingContent visible={visible} className="z-10 relative">
         <div className="absolute top-0 left-0 right-0 h-[4em] px-[1em] min-[700px]:px-[2em] flex justify-between items-center font-micro5 text-[1.75em] min-[700px]:text-[2.25em]">
