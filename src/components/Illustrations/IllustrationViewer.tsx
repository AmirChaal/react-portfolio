   ...
   return (
      <>
         ...
         <AppearingContent visible={visible} className="z-[101] absolute h-full w-full top-0 left-0 flex flex-col min-[1000px]:flex-row gap-[1em] justify-center items-center pointer-events-none!">
            {imageObject && (
               <div className="relative h-[85%] min-[1000px]:h-[95%] w-[95%] min-[1000px]:w-[75%] overflow-hidden shadow-[0_0_25px_0_rgba(0,0,0,0.4)]">
                  <img className="absolute inset-0 h-full w-full object-cover scale-110 blur-lg brightness-[35%]" src={imageObject.path} alt="" />
                  <img className="relative h-full w-full object-contain pointer-events-auto" src={imageObject.path} alt="" />
               </div>
            )}
